                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <div class="wsus__topbar_select">
                                                <select class="select_2" name="countery">
                                                    <option>Select</option>
                                                    @foreach (config('settings.country_list') as $countery)
                                                        <option {{$countery == $address->countery ? 'selected' : ''}} value="{{ $countery }}">{{ $countery }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
