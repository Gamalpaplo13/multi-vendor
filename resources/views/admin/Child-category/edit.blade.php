                    ...
                    <div class="form-group">
                        ...
                        <select id="inputState" class="form-control sub-category" name="sub_category">
                            ...
                            @foreach ($subCategories as $subCategory)
                                <option  {{$subCategory->id == $childCategory->category_id ? 'selected' : ''}}   value="{{$subCategory->id}}">{{$subCategory->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" class="form-control" id="" value="{{$childCategory->name}}">
                    </div>
                    <div class="form-group">
