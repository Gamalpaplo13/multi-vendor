@php
    ...
    // dd($popularCategoriesSection);
@endphp

<div class="tab-pane fade show active" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.popular-category-section') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <h5>Category 1</h5>
                <div class="row">
                        ...
                        <div class="form-group">
                            @php
                                $subCategories = \App\Models\SubCategory::where(
                                    'category_id',
                                    $popularCategoriesSection[0]->category,
                                )->get();
                            @endphp
                        ...
                        <div class="form-group">
                            @php
                                $childCategories = \App\Models\ChildCategory::where(
                                    'sub_category_id',
                                    $popularCategoriesSection[0]->child_category,
                                )->get();
                            @endphp
