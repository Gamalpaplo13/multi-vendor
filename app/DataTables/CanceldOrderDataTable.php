...
class CanceldOrderDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('order_status','canceld')->newQuery();
    }
    ...
    {
        return 'CanceldOrder_' . date('YmdHis');
    }
}
